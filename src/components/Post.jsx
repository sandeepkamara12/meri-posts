...
const Post = ({ alignment, data: post, deletedPost }) => {
  return (
    ...
    >
      ...
      >
        <div className="shrink-0 relative rounded-xl overflow-hidden h-[200px] sm:w-[200px] sm:h-[250px] w-full">
          <a href="#">
            <img
        ...
        <div className="grow">
          <div className="p-4 flex flex-col h-full sm:p-6">
            ...
            <a href="#" className="text-lg sm:text-2xl font-semibold text-gray-800 group-hover:text-blue-600 group-focus:text-blue-600 dark:text-neutral-300 dark:group-hover:text-white dark:group-focus:text-white">
