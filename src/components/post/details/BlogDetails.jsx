              ...
              <div className="">
                ...
                <div className="space-y-5 md:space-y-10">
                  <div className="space-y-3">
                    ...
                    <p className=" mt-1 text-md text-gray">{blog?.body}</p>
                    <p className=" mt-1 text-md text-gray">{blog?.body}</p>
                  </div>
                  ...
                  <h3 className="text-lg xl:text-2xl font-semibold dark:text-white">
                    Bringing the culture of sharing to everyone
                  </h3>
                  <p className=" mt-1 text-md text-gray">{blog?.body}</p>
                  <ul className="list-disc list-outside space-y-5 ps-5 text-md">
                    <li className="ps-2">
