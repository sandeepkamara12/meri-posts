...
// Need to work on facebook and linkedin share with live links because it does not work with localhost url.
// Also share with Image.

const SharePostSocial = ({ classes, isOpenShareDropdown, post }) => {
