...
const Footer = () => {
  return (
    <footer className="mt-auto bg-white sticky bottom-0 py-4 md:py-8  border-t border-gray inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-[48] text-sm px-4 sm:px-6">
      <div className="grid grid-cols-2 items-center gap-2 md:gap-5 max-w-4xl w-full mx-auto">
        <div className="text-sm text-gray-500">&copy; 2025, Code Spark</div>
        ...
        {/* <ul className="text-center">
          <li className="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 dark:before:text-neutral-600">
            <a className="inline-flex gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="#">
              About
            </a>
          </li>
          <li className="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 dark:before:text-neutral-600">
