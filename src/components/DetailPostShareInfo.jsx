            ...
            <div className="inline-block bg-white sm:shadow-md rounded-xs sm:rounded-full py-3 px-4 w-full sm:w-auto">
                <div className="grid grid-cols-3 sm:grid-cols-auto sm:flex items-center flex-col sm:flex-row gap-x-1.5 gap-y-1.5">
                    <div className="hs-tooltip inline-block w-full sm:w-auto" >
                        <button
                            type="button"
                            className="like group w-full py-2 sm:py-0 px-3 sm:px-0 focus:outline-none focus:bg-gray-50 font-medium rounded-lg border sm:border-0 border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none hs-tooltip-toggle flex items-center justify-center gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                        >
                            <svg
                                fill="currentColor"
                            ...
                            <Tooltip anchorSelect=".like" place="top" className='!bg-black !py-1 !px-2 !text-xs'>
                                Like
                            </Tooltip>
                        </button>
                    </div>
                    ...
                    <div className="hs-tooltip inline-block w-full sm:w-auto">
                        <button
                            type="button"
                            className="dislike w-full py-2 sm:py-0 px-3 sm:px-0 focus:outline-none focus:bg-gray-50 font-medium rounded-lg border sm:border-0 border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none hs-tooltip-toggle flex items-center justify-center gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                        >
                            <svg
                                fill="currentColor"
                                className="size-4 shrink-0"
                            ...
                            <Tooltip anchorSelect=".dislike" place="top" className='!bg-black !py-1 !px-2 !text-xs'>
                                Dislike
                            </Tooltip>
                        </button>
                    </div>
                    ...
                    <div className="hs-tooltip inline-block w-full sm:w-auto">
                        <button
                            type="button"
                            className="views w-full py-2 sm:py-0 px-3 sm:px-0 focus:outline-none focus:bg-gray-50 font-medium rounded-lg border sm:border-0 border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none hs-tooltip-toggle flex items-center justify-center gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            {blog?.views}
                            <Tooltip anchorSelect=".views" place="top" className='!bg-black !py-1 !px-2 !text-xs'>
                                Views
                            </Tooltip>
                        </button>
                    </div>
                    ...
                    <div className="hs-tooltip inline-block w-full sm:w-auto">
                        <button
                            type="button"
                            className="comments w-full py-2 sm:py-0 px-3 sm:px-0 focus:outline-none focus:bg-gray-50 font-medium rounded-lg border sm:border-0 border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none hs-tooltip-toggle flex items-center justify-center gap-x-2 text-sm text-gray-500 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                        >
                            <svg
                                className="shrink-0 size-4"
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span>16</span>
                            <Tooltip anchorSelect=".comments" place="top" className='!bg-black !py-1 !px-2 !text-xs'>
                                Comments
                            </Tooltip>
                        </button>
                    </div>
